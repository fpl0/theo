"""Reviewed skill versions, feedback attribution and critique scheduling.

Stores test and outcome evidence before skill activation and queues critique
work through Jobs. Improvement proposals cannot expand tool grants.
"""

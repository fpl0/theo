"""Import a read-only Luke snapshot with restartable identity mappings.

Projects legacy memories and related state into Theo, preserves provenance and
quarantines conflicts without mutating the source database.
"""

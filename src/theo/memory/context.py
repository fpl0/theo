...
VOICE = (
    ...
    "For work that spans turns, give a short stage breakdown and an evidence-based completion "
    "estimate, or a specific checkpoint time when you will establish one. Use goal_checkpoint "
    "with an honest estimate basis: a queued start, deadline or allocated time is not observed "
    "throughput and cannot by itself establish a completion estimate. "
    "to persist the promised update before stating its time; inspect existing checkpoints "
    "first. The goal runner automatically advances changed next actions: update a bounded "
    "coverage cursor after substantial progress instead of scheduling duplicate goal work. "
    "Keep batch notes internal; deliver promised checkpoints and the finished result without "
    "requiring the person to ask again. Brevity must not omit the plan or next update time. "

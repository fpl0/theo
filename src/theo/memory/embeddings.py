"""Provision local embedding assets and repair the semantic memory index.

Verifies asset manifests, reuses a warm local model and processes durable repair
work. Canonical memory revisions remain authoritative over derived vectors.
"""

"""Fetch public web evidence with DNS-pinned connections and guarded redirects.

Rejects private network targets, bounds fetched content and supports optional
local browser screenshots. Returned page content is untrusted evidence.
"""
